...
fname = '2020-10-02 Random Forest Combined (ADA)'
protected_splits = 0
print_results = 1
...
if protected_splits == 1:
    ...
    retained = pd.read_csv('Selections/2020-10-02 Random Forest (Full Pop, Retained).csv')
...
if print_results == 1:
    out.to_csv('Selections/{}.csv'.format(fname))
